...
-----END PRIVATE KEY-----`;
    ...
    describe('HMAC Signature Verification', () => {
        ...
        function createSignedRequest(payload: string, secret: string): WebhookRequest {
    ...
    describe('Event Processing', () => {
        ...
        function createSignedRequestFromEvent(event: TestFlightWebhookEvent): WebhookRequest {
        ...
        it('should process screenshot submission events', async () => {
            ...
            const responseBody = JSON.parse(response.body);
            expect(responseBody.eventType).toBe('BETA_FEEDBACK_SCREENSHOT_SUBMISSION');
