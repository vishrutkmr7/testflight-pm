...
const createMockCrashFeedback = (overrides: Partial<ProcessedFeedbackData> = {}): ProcessedFeedbackData => ({
    id: 'crash-123',
    type: 'crash',
...
const createMockScreenshotFeedback = (overrides: Partial<ProcessedFeedbackData> = {}): ProcessedFeedbackData => ({
    id: 'screenshot-456',
    type: 'screenshot',
    ...
    screenshotData: {
        ...
        annotations: [
            { x: 100, y: 200, width: 50, height: 30, text: 'Button issue here' },
        ],
    },
    ...overrides,
});
...
describe('Linear Utilities', () => {
    ...
    describe('formatFeedbackForLinear', () => {
        test('should format crash feedback with proper title and description', () => {
            ...
            expect(description).toContain('**Exception Type:** `NSInvalidArgumentException`');
            ...
            expect(description).toContain('- [Crash Log 1](https://example.com/crash-log-1.txt)');
        });
        ...
        test('should format screenshot feedback with proper title and description', () => {
            ...
            expect(description).toContain('> The login button is not working properly');
            expect(description).toContain('### Screenshots (1)');
            expect(description).toContain('- [screenshot-1.png](https://example.com/screenshot-1.png)');
        ...
        test('should include technical details section', () => {
            ...
            expect(description).toContain('<summary>Device & Environment Information</summary>');
        ...
        test('should include auto-generated footer', () => {
            ...
            expect(description).toContain('*This issue was automatically created from TestFlight feedback');
        ...
        test('should truncate long titles appropriately', () => {
            const longText = 'This is a very long feedback text that should be truncated in the title to avoid creating extremely long issue titles that would be difficult to read and manage in Linear workspace';
    ...
    describe('validateLinearIntegration', () => {
        test('should return valid when configuration is present', () => {
            ...
            const mockValidateLinearConfig = mock(() => true);
        ...
        test('should return invalid when configuration is missing', () => {
            ...
            const mockValidateLinearConfig = mock(() => false);
    ...
    describe('edge cases and error handling', () => {
        ...
        test('should handle special characters in feedback text', () => {
            const specialText = 'Special chars: <script>alert("xss")</script> & "quotes" & \n\r newlines';
