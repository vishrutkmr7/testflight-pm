...
import { LinearClient, validateLinearConfig, clearLinearClientInstance } from '../src/api/linear-client.js';
...
describe('Linear Client', () => {
    ...
    describe('Configuration Validation', () => {
        ...
        test('should invalidate missing Linear configuration', () => {
            // Mock missing config
            const originalGetConfig = mockConfig;
            mock.module('../src/config/environment.js', () => ({
    ...
    describe('LinearClient instantiation', () => {
        ...
        test('should throw error with invalid configuration', () => {
            ...
            expect(() => new LinearClient()).toThrow(/Linear configuration not found/);
        });
    ...
    describe('Issue Creation from TestFlight Feedback', () => {
        test('should format crash feedback correctly for Linear', () => {
            ...
            const mockCreateIssue = mock().mockResolvedValue(mockLinearIssue);
            const mockFindDuplicate = mock().mockResolvedValue(null);
            const mockResolveLabelIds = mock().mockResolvedValue(['label-1', 'label-2']);
    ...
    describe('Duplicate Detection', () => {
        test('should detect duplicate issues based on feedback ID', () => {
            ...
            const mockFindDuplicate = mock().mockResolvedValue(mockLinearIssue);
    ...
    describe('Issue Management', () => {
        ...
        test('should add comments to existing issues', async () => {
            ...
            const mockAddComment = mock().mockResolvedValue(mockLinearComment);
    ...
    describe('Team and Project Management', () => {
        test('should fetch team information correctly', async () => {
            ...
            // Mock team fetch
            const mockGetTeam = mock().mockResolvedValue(mockLinearTeam);
        ...
        test('should fetch current user information', async () => {
            ...
            // Mock user fetch
            const mockGetCurrentUser = mock().mockResolvedValue(mockLinearUser);
    ...
    describe('Health Check', () => {
        ...
        test('should return unhealthy status when API calls fail', async () => {
            ...
            const mockGetTeam = mock().mockRejectedValue(new Error('API Error'));
    ...
    describe('Error Handling', () => {
        test('should handle network errors gracefully', async () => {
            ...
            // Mock network error
            const mockNetworkError = mock().mockRejectedValue(new Error('Network error'));
        ...
        test('should handle API rate limiting', async () => {
            ...
            const mockRateLimitError = mock().mockRejectedValue(new Error('Rate limit exceeded'));
        ...
        test('should handle invalid authentication', async () => {
            ...
            const mockAuthError = mock().mockRejectedValue(new Error('Invalid authentication'));
    ...
    describe('MCP Integration Readiness', () => {
        ...
        test('should throw meaningful errors when MCP is not connected', async () => {
            ...
            await expect(client.createIssueFromTestFlight(feedback)).rejects.toThrow(/MCP Linear integration not yet connected/);
        });
